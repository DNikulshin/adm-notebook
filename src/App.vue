<template>
    ...
    <div class="container">
      ...
      <section v-else @click.stop>
        <div class="notes-area" v-if="dataArray.length">
          <ul class="list-group">
            <li class="list-group-item mb-2 border item-shadow" v-for="(item, idx) in dataArray.sort((b,a) => a.date.localeCompare(b.date))" :key="item.id"
                ...
                <div class="info">
                  <small class="mx-1 text-nowrap date-time">
                    ...
                    <span class="d-flex flex-row-reverse flex-nowrap">
                      <i class="text-dark mx-2 pe-1" @click.prevent="toggleTools(item)"
                      ...
                      <span v-show="item.showTools">
                        <i @click="toggleDoneItem(item)">
                          <svg v-if="!item.done" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                        ...
                        <i class="text-danger btn-hover mx-2" @click.prevent="removeTodo(item.id, idx)">
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
  ...
  <div v-else
    ...
    <a class="refresh text-primary" href="/" @click="window?.location?.reload()">
